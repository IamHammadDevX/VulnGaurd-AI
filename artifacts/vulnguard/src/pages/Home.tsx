...
const SeverityChart = lazy(() =>
  import("@/components/SeverityChart").then((module) => ({ default: module.SeverityChart }))
);
...
function Scanner() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      {/* ── Header ── */}
      <header className="border-b border-white/6 bg-[#0a0a0a]/40 backdrop-blur-2xl sticky top-0 z-50 shrink-0">
        <div className="max-w-[1600px] mx-auto px-4 h-14 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link href="/">
              <a className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0a0a0a] hover:bg-white/10 border border-white/8 text-zinc-500 hover:text-white text-xs font-medium transition-colors">
                Home
              </a>
            </Link>
            {result && (
              <motion.button
                ...
                className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 border border-primary/20 text-white text-xs font-bold transition-colors"
              >
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0a0a0a] hover:bg-white/10 border border-white/8 text-zinc-500 hover:text-white text-xs font-medium transition-colors"
            >
      ...
      {/* ── Mobile Tab Bar ── */}
      <div className="lg:hidden sticky top-14 z-40 bg-black/90 backdrop-blur-xl border-b border-white/6">
        <div className="flex">
          {(["editor", "results"] as const).map((tab) => (
            <button
              ...
              className={cn(
                ...
                mobileTab === tab ? "text-white" : "text-zinc-500 hover:text-white"
              )}
            >
              {tab === "editor"
          ...
          <AnimatePresence mode="wait">
            ...
            {isShowingResults && (
              ...
              >
                ...
                {/* ── Status bar ── */}
                <div className="glass-panel px-4 py-3 rounded-xl shrink-0 flex flex-wrap items-center gap-3">
                  {/* Phase pill */}
                  <div className={cn(
                ...
                {(result || (riskScore !== null && partialVulns.length > 0)) && (
                  <motion.div
                    initial={{ opacity: 0, y: 8 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="glass-panel p-4 rounded-xl shrink-0"
                  >
