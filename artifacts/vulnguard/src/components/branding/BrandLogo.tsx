  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      <span className="grid h-10 w-10 place-items-center rounded-2xl border border-emerald-500/25 bg-[linear-gradient(135deg,rgba(16,185,129,0.22),rgba(244,114,182,0.08),rgba(9,9,11,0.96))] p-[1px] shadow-[0_18px_44px_-28px_rgba(16,185,129,0.9)]">
        <span className="grid h-full w-full place-items-center rounded-[15px] bg-[radial-gradient(circle_at_top,rgba(63,63,70,0.28),rgba(9,9,11,0.98)_62%)] text-zinc-50">
      ...
      <span className={cn("flex flex-col", textClassName)}>
        <span className="font-display text-[15px] font-semibold leading-tight tracking-[0.02em] text-zinc-50">VulnGuard AI</span>
        {showTagline && <span className="text-[10px] leading-tight text-zinc-500">{tagline}</span>}
      </span>
    </div>
  );
}
